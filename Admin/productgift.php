...
if (isset($_POST['save_product'])) {
    ...
    if (move_uploaded_file($tmp_name, $upload_path)) {
        ...
        if (mysqli_query($conn, $sql_insert)) {
            echo "<script>alert('Product saved successfully!'); window.location='productgift.php';</script>";
        } else {
...
<head>
    ...
    <title>Crochet Admin - Gift Management</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        body { background-color: #f8f9fa; }
        /* Sidebar Styles (Moved to CSS block for cleaner code) */
...
<div class="container-fluid">
    <div class="row"> <?php include('sidebar.php'); ?>

        <div class="col-lg-10 p-4">
            <h3 class="mb-4 text-secondary">Gift Product Management</h3>

            <div class="card shadow-sm border-0 mb-5 p-4">
                <h5 class="mb-3 text-danger"><i class="fa fa-plus-circle"></i> Add New Gift</h5>
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <label class="form-label fw-bold">Category (Gift Only)</label>
                ...
                <table class="table table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        $sql_select = "SELECT PRODUCTLIST.*, CATEGORYLIST.CAT_NAME 
                                       ...
                                       WHERE CATEGORYLIST.CAT_NAME = 'Gift'
                        ...
                        if(mysqli_num_rows($result) > 0) {
                            ...
                            <tr>
                                <td><?php echo $i++; ?></td>
                                <td><img src="uploads/<?php echo $row['PRO_IMG']; ?>" width="50" height="50" class="rounded border" onerror="this.src='https://via.placeholder.com/50'"></td>
                            ...
                            <?php } } else {
                                echo "<tr><td colspan='6' class='text-center'>No gifts found.</td></tr>";
                            } ?>
                    </tbody>
                </table>
            </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    for (let i = options.length - 1; i >= 0; i--) {
        ...
        if (catName && catName.includes('gift')) {
